    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <img src="../application/views/images/img1.jpg" width="227" height="205" alt="" class="fl" />
        ...
        <div class="article">
          ...
          <img src="../application/views/images/img2.jpg" width="227" height="205" alt="" class="fl" />
      ...
      <div class="sidebar">
        <div class="searchform">
          <form id="formsearch" name="formsearch" method="post" action="#">
            ...
            <input name="button_search" src="../application/views/images/search_btn.gif" class="button_search" type="image" />
          </form>
        </div>
        <div class="gadget">
